...
<body>
    <div class="form-card text-center">
        <h2 class="mb-1">👋 Login teacher</h2>
        <p class="text-muted">Email: <strong>{{ session('email') }}</strong> | Role: <strong>{{ session('role') }}</strong></p>

        <hr class="my-4">

        <h4 class="mb-3">Lengkapi Data Dosen</h4>
        <form method="POST" action="/dashboard/teacher" class="text-start">
            @csrf
            <div class="mb-3">
            ...
            <div class="d-grid">
                <button type="submit" class="btn btn-primary">Lanjut ke Menu Dosen</button>
            </div>
        </form>
    </div>
